...
<details><summary>Transport restrictions and accessibility advisories</summary>${json({ reference: r.reference.blocked, candidate: r.candidate.blocked, advisory: r.candidate.advisory })}</details>
