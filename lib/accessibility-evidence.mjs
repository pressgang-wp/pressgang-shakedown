...
export async function captureElementEvidence(page, findings, path, options = {}) {
...
// Existing accessibility callers share the same unchanged capture mechanics.
export const captureAccessibilityEvidence = captureElementEvidence;
