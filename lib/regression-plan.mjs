...
export function regressionOptions(raw, discovery, flags = {}) {
  keys(raw, ['references', 'candidates', 'defaultReference', 'defaultCandidate', 'viewports', 'defaultViewports', 'defaultLevel', 'ignoreSelectors', 'accept', 'criticalRoutes', 'navigationLimit', 'timeout'], 'regression');
  ...
  return { level, referenceName, candidateName, reference, candidate, discovery: origin(discovery), viewports: selectViewports(configuredViewports, raw.defaultViewports, flags.viewports), ...lists, navigationLimit, timeout };
}
