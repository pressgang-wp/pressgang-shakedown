...
export const IGNORE_KEYS = {
  imageIssues: 'regression image/layout issue IDs, messages or element selectors',
  ...
  errorSignatures: 'error-output matches in a page body, "<signature> on <url>" (pass 00)',
